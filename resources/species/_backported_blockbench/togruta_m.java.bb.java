public class togruta_m.nem
public togruta_m.nem
texWidth = 150;
texHeight = 150;
...
TailMidR.setPos(-1.0F, 2.7F, 2.3F);
TailBaseR.addChild(TailMidR);
setRotationAngle(TailMidR, -0.22759093F, -0.13665928F, 0.091106184F);
TailMidR.texOffs(20, 71).addBox(-3.0F, 0.0F, 0.0F, 3F, 7F, 3F, 0.0F, true);
TailLowerR = new ModelRenderer(this);
TailLowerR.setPos(-0.9F, 6.4F, 0.5F);
TailMidR.addChild(TailLowerR);
setRotationAngle(TailLowerR, 0.31869712F, 0.0F, -0.27314404F);
TailLowerR.texOffs(32, 71).addBox(-2.0F, 0.0F, 0.0F, 2F, 4F, 2F, 0.0F, true);
TailUpperR = new ModelRenderer(this);
TailUpperR.setPos(-1.2F, -1.0F, -1.3F);
TailBaseR.addChild(TailUpperR);
setRotationAngle(TailUpperR, 0.8196066F, 0.0F, -0.27314404F);
TailUpperR.texOffs(41, 71).addBox(-3.0F, 0.0F, 0.0F, 3F, 5F, 3F, 0.0F, true);
TailTipR = new ModelRenderer(this);
TailTipR.setPos(0.0F, -2.1F, 0.5F);
TailUpperR.addChild(TailTipR);
setRotationAngle(TailTipR, 0.0F, 0.0F, 0.27314404F);
...
TailLowerB.setPos(1.0F, 10.0F, -0.4F);
TailMidB.addChild(TailLowerB);
setRotationAngle(TailLowerB, 0.0F, 0.0F, 0.0F);
TailLowerB.texOffs(49, 83).addBox(0.0F, 0.0F, 0.0F, 2F, 4F, 2F, 0.0F, true);
...
TailMidL.setPos(1.0F, 2.7F, 2.3F);
TailBaseL.addChild(TailMidL);
setRotationAngle(TailMidL, -0.22759093F, 0.13665928F, -0.091106184F);
TailMidL.texOffs(20, 71).addBox(0.0F, 0.0F, 0.0F, 3F, 7F, 3F, 0.0F, false);
TailLowerL = new ModelRenderer(this);
TailLowerL.setPos(0.9F, 6.4F, 0.5F);
TailMidL.addChild(TailLowerL);
setRotationAngle(TailLowerL, 0.31869712F, 0.0F, 0.27314404F);
TailLowerL.texOffs(32, 71).addBox(0.0F, 0.0F, 0.0F, 2F, 4F, 2F, 0.0F, false);
TaiUpperL = new ModelRenderer(this);
TaiUpperL.setPos(1.2F, -1.0F, -1.3F);
TailBaseL.addChild(TaiUpperL);
setRotationAngle(TaiUpperL, 0.8196066F, 0.0F, 0.27314404F);
TaiUpperL.texOffs(41, 71).addBox(0.0F, 0.0F, 0.0F, 3F, 5F, 3F, 0.0F, false);
TaiTipL = new ModelRenderer(this);
TaiTipL.setPos(0.0F, -2.1F, 0.5F);
TaiUpperL.addChild(TaiTipL);
setRotationAngle(TaiTipL, 0.0F, 0.0F, -0.27314404F);
