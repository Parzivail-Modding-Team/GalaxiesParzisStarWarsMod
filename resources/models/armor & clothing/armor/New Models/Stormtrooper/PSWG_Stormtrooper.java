...
public class PSWG_Stormtrooper<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(79, 84).addBox(3.5F, -6.75F, 11.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(17, 91).addBox(-3.5F, -0.75F, 11.75F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(88, 56).addBox(-3.75F, -5.75F, 14.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(68, 52).addBox(-0.5F, -4.75F, 14.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 6.25F, -8.5F));
