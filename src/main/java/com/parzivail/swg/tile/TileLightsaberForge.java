...
public class TileLightsaberForge extends TileEntity implements IInventory
{
	...
	{
		return Resources.containerDot(BlockRegister.lightsaberForge.name);
	}
	...
	{
		return stack != null && stack.getItem() instanceof ItemLightsaber;
	}
