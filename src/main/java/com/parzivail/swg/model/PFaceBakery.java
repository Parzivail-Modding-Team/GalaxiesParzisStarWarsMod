...
public class PFaceBakery
{
	...
	private static final Rotation UV_ROTATION_270 = new Rotation()
	{
		BlockFaceUV makeRotatedUV(float p_188007_1_, float p_188007_2_, float p_188007_3_, float p_188007_4_)
		{
			return new BlockFaceUV(new float[] {
					p_188007_4_, 16.0F - p_188007_1_, p_188007_2_, 16.0F - p_188007_3_
			}, 270);
		}
	};
	private static final Rotation UV_ROTATION_INVERSE = new Rotation()
	{
		...
		{
			return new BlockFaceUV(new float[] {
					16.0F - p_188007_1_, 16.0F - p_188007_2_, 16.0F - p_188007_3_, 16.0F - p_188007_4_
			}, 0);
		}
	};
	private static final Rotation UV_ROTATION_90 = new Rotation()
	{
		...
		{
			return new BlockFaceUV(new float[] {
					16.0F - p_188007_2_, p_188007_3_, 16.0F - p_188007_4_, p_188007_1_
			}, 90);
		}
	};
	...
	private void rotatePart(Vector3f p_178407_1_, @Nullable BlockPartRotation partRotation, Vector3f partRotated)
	{
		if (partRotated == null)
			rotatePart(p_178407_1_, partRotation);
		else
		{
			if (partRotation != null)
			{
				...
				Matrix4f.rotate(partRotated.z * 0.017453292F, new Vector3f(0.0F, 0.0F, 1.0F), matrix4f, matrix4f);
				Matrix4f.rotate(partRotated.y * 0.017453292F, new Vector3f(0.0F, 1.0F, 0.0F), matrix4f, matrix4f);
				Matrix4f.rotate(partRotated.x * 0.017453292F, new Vector3f(1.0F, 0.0F, 0.0F), matrix4f, matrix4f);
