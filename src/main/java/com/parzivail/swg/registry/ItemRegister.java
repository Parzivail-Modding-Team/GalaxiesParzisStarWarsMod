...
public class ItemRegister
{
	...
	{
		register(rifleA280 = new ItemBlasterRifle(new BlasterDescriptor("a280", 8, 1, 300, 1300, 6.7f, 25, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleBowcaster = new ItemBlasterRifle(new BlasterDescriptor("bowcaster", 12, 1, 50, 1500, 8f, 6, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleCycler = new ItemBlasterRifle(new BlasterDescriptor("cycler", 8, 1, 300, 900, 6f, 12, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleDefender = new ItemBlasterRifle(new BlasterDescriptor("defender", 4, 1, 30, 350, 1f, 100, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleDh17 = new ItemBlasterRifle(new BlasterDescriptor("dh17", 4, 1, 50, 550, 1f, 25, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleDl18 = new ItemBlasterRifle(new BlasterDescriptor("dl18", 4, 1, 100, 500, 1f, 100, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleDl21 = new ItemBlasterRifle(new BlasterDescriptor("dl21", 4, 1, 100, 500, 1f, 100, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleDlt19 = new ItemBlasterRifle(new BlasterDescriptor("dlt19", 16, 1, 300, 1600, 13f, 30, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleE11 = new ItemBlasterRifle(new BlasterDescriptor("e11", 7, 1, 300, 1000, 4.5f, 50, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleIonization = new ItemBlasterRifle(new BlasterDescriptor("ionization", 4, 1, 12, 80, 3f, 2, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleRt97c = new ItemBlasterRifle(new BlasterDescriptor("rt97c", 11, 1, 1500, 2000, 11f, 50, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleScout = new ItemBlasterRifle(new BlasterDescriptor("scout", 4, 1, 60, 300, 1f, 10, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleSe14c = new ItemBlasterRifle(new BlasterDescriptor("se14c", 4, 1, 100, 500, 1f, 20, GLPalette.ANALOG_RED, 10, 30)));
		register(rifleT21 = new ItemBlasterRifle(new BlasterDescriptor("t21", 8, 1, 200, 2000, 4.5f, 30, GLPalette.ANALOG_RED, 10, 30)));
