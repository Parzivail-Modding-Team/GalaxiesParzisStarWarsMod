...
public class RenderSkyTatooine extends net.minecraftforge.client.IRenderHandler
{
	...
	{
		int pass = 1;
		TextureManager renderEngine = mc.getRenderManager().renderEngine;
		Entity player = mc.getRenderViewEntity();
		if (player == null)
			return;

		GlStateManager.disableTexture2D();
		Vec3d vec3d = world.getSkyColor(player, partialTicks);
