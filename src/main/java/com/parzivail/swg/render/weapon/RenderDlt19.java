...
{
	private static final ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/blaster/rifle.dlt19.png");

	private final ModelDlt19 model;

	public RenderDlt19()
	{
		model = new ModelDlt19();
	}
