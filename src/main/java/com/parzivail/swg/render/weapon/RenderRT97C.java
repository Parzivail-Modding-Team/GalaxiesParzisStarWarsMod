...
{
	private static final ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/blaster/rifle.rt97c.png");

	private final ModelRT97C model;

	public RenderRT97C()
	{
		model = new ModelRT97C();
	}
