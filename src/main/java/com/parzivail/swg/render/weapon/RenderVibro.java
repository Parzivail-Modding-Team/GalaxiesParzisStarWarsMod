...
import com.parzivail.swg.render.model.weapon.ModelVibro;
...
{
	private static ResourceLocation texture = new ResourceLocation(Resources.MODID, "textures/weapon/melee.vibro.png");
