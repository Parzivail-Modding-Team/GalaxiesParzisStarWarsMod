...
/**
 * ModelBothanM - Sindavar
 * Created using Tabula 4.1.1
 */
public class ModelBothanM extends PModelBipedBase
{
	private static final ResourceLocation texture = Resources.location("textures/species/bothan_m.png");
	...
	public ModelBothanM()
	{
		...
		BeardF = new ModelRenderer(this, 52, 21);
		BeardF.setRotationPoint(0.0F, 0.4F, -4.5F);
		BeardF.addBox(-1.5F, 0.0F, 0.0F, 3, 0, 5, 0.0F);
		setRotateAngle(BeardF, -1.3847442285323013F, 0.0F, 0.0F);
