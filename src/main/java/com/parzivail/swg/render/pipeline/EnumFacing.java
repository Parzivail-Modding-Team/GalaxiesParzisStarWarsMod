...
{
	DOWN(0, 1, -1, "down", EnumFacing.AxisDirection.NEGATIVE, EnumFacing.Axis.Y, Vec3.createVectorHelper(0, -1, 0)),
	UP(1, 0, -1, "up", EnumFacing.AxisDirection.POSITIVE, EnumFacing.Axis.Y, Vec3.createVectorHelper(0, 1, 0)),
	NORTH(2, 3, 2, "north", EnumFacing.AxisDirection.NEGATIVE, EnumFacing.Axis.Z, Vec3.createVectorHelper(0, 0, -1)),
	SOUTH(3, 2, 0, "south", EnumFacing.AxisDirection.POSITIVE, EnumFacing.Axis.Z, Vec3.createVectorHelper(0, 0, 1)),
	WEST(4, 5, 1, "west", EnumFacing.AxisDirection.NEGATIVE, EnumFacing.Axis.X, Vec3.createVectorHelper(-1, 0, 0)),
	EAST(5, 4, 3, "east", EnumFacing.AxisDirection.POSITIVE, EnumFacing.Axis.X, Vec3.createVectorHelper(1, 0, 0));
	...
	EnumFacing(int indexIn, int oppositeIn, int horizontalIndexIn, String nameIn, EnumFacing.AxisDirection axisDirectionIn, EnumFacing.Axis axisIn, Vec3 directionVecIn)
	{
		index = indexIn;
	...
	public static EnumFacing getFacingFromVector(float x, float y, float z)
	{
		...
		{
			float f1 = x * (float)enumfacing1.directionVec.xCoord + y * (float)enumfacing1.directionVec.yCoord + z * (float)enumfacing1.directionVec.zCoord;
