...
public class ModelConsoleHoth1 extends ModelBase
{
	...
	public void drawGlass()
	{
		...
		GL11.glLineWidth(2);
		Fx.D2.DrawLine(-0.6f, 0.2f, -0.6f, -1f);
		Fx.D2.DrawLine(-0.4f, 0.2f, -0.4f, -1f);
		Fx.D2.DrawLine(-0.2f, 0.2f, -0.2f, -1f);
		Fx.D2.DrawLine(-0f, 0.2f, -0f, -1f);
		Fx.D2.DrawLine(0.15f, 0.2f, 0.15f, -1f);
		Fx.D2.DrawLine(0.27f, 0.2f, 0.27f, -1f);
		Fx.D2.DrawLine(0.36f, 0.2f, 0.36f, -1f);
		Fx.D2.DrawLine(0.46f, 0.2f, 0.46f, -1f);
		Fx.D2.DrawLine(0.56f, 0.2f, 0.56f, -1f);
		Fx.D2.DrawLine(0.65f, 0.2f, 0.65f, -1f);

		GL11.glColor3f(1, 1, 1);

		GL11.glLineWidth(2);
		Fx.D2.DrawLine(-0.7f, -0.9f, 0.46f, -0.07f);

		GL.Scale(0.01);
		GL11.glLineWidth(3.5f);
		Fx.D2.DrawWireCircle(0, -25f, 65f);

		GL11.glLineWidth(2);
		GL11.glScalef(1.2f, 1.2f, 0);
		GL11.glTranslatef(-10f, 0, 0);
		Fx.D2.DrawWireCircle(46f, -7.5f, 10f);
		Fx.D2.DrawWireCircle(33f, -15f, 30f);
		Fx.D2.DrawWireCircle(36f, -12f, 26f);
		Fx.D2.DrawWireCircle(37f, -12f, 20f);
		Fx.D2.DrawWireCircle(47f, -8f, 14.5f);
		Fx.D2.DrawWireCircle(42f, -10f, 17f);
		GL11.glPopMatrix();
	}
