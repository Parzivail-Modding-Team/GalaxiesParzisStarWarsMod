...
public class RenderWallControlPanel extends TileEntitySpecialRenderer
{
	public static ResourceLocation texture = Resources.location("textures/model/wallControlPanel.png");

	private final ModelBase model;

	public RenderWallControlPanel()
	{
		this.model = new ModelWallControlPanel();
	}
