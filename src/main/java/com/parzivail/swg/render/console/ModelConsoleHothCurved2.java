...
public class ModelConsoleHothCurved2 extends ModelBase
{
	...
	public ModelConsoleHothCurved2()
	{
		textureWidth = 512;
		textureHeight = 512;
		shape1_11 = new ModelRenderer(this, 65, 0);
		shape1_11.setRotationPoint(0.0F, 0.0F, 0.0F);
		shape1_11.addBox(-7.0F, -9.71F, 8.6F, 7, 4, 4, 0.0F);
		setRotateAngle(shape1_11, 0.7853981633974483F, 0.0F, 0.0F);
		shape1_10 = new ModelRenderer(this, 50, 0);
		shape1_10.setRotationPoint(0.0F, 0.0F, 0.0F);
		shape1_10.addBox(-7.0F, -9.0F, 2.0F, 3, 12, 1, 0.0F);
		Light_4 = new ModelRenderer(this, 76, 53);
		Light_4.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_4.addBox(-6.0F, 4.0F, 1.6F, 1, 1, 1, 0.0F);
		shape1_9 = new ModelRenderer(this, 0, 254);
		shape1_9.setRotationPoint(0.0F, 0.0F, 0.0F);
		shape1_9.addBox(-3.0F, -9.0F, 2.0F, 10, 12, 1, 0.0F);
		shape1_13 = new ModelRenderer(this, 112, 0);
		shape1_13.setRotationPoint(0.0F, 0.0F, 0.0F);
		shape1_13.addBox(4.0F, -9.71F, 8.6F, 3, 1, 4, 0.0F);
		setRotateAngle(shape1_13, 0.7853981633974483F, 0.0F, 0.0F);
		shape1_12 = new ModelRenderer(this, 96, 0);
		...
		Light_2 = new ModelRenderer(this, 78, 31);
		Light_2.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_2.addBox(-6.0F, 0.0F, 1.6F, 1, 1, 1, 0.0F);
		Light_5 = new ModelRenderer(this, 98, 53);
		Light_5.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_5.addBox(6.0F, -5.51F, 6.6F, 1, 1, 4, 0.0F);
		setRotateAngle(Light_5, 0.7853981633974483F, 0.0F, 0.0F);
		Light = new ModelRenderer(this, 60, 27);
		Light.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light.addBox(-6.0F, -5.0F, 1.6F, 1, 2, 1, 0.0F);
		shape1_2 = new ModelRenderer(this, 0, 81);
		shape1_2.setRotationPoint(0.0F, 0.0F, 0.0F);
		shape1_2.addBox(5.0F, 7.0F, -6.0F, 3, 14, 9, 0.0F);
		Light_6 = new ModelRenderer(this, 120, 40);
		Light_6.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_6.addBox(4.0F, -5.51F, 6.6F, 1, 1, 4, 0.0F);
		setRotateAngle(Light_6, 0.7853981633974483F, 0.0F, 0.0F);
		Light_1 = new ModelRenderer(this, 95, 34);
		Light_1.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_1.addBox(-6.0F, -2.0F, 1.6F, 1, 1, 1, 0.0F);
		shape1_8 = new ModelRenderer(this, 0, 234);
		...
		Light_3 = new ModelRenderer(this, 58, 49);
		Light_3.setRotationPoint(0.0F, 0.0F, 0.0F);
		Light_3.addBox(-6.0F, 2.0F, 1.6F, 1, 1, 1, 0.0F);
		shape1_6 = new ModelRenderer(this, 0, 189);
		...
		shape1_3 = new ModelRenderer(this, 0, 116);
		...
		shape1_5 = new ModelRenderer(this, 0, 165);
