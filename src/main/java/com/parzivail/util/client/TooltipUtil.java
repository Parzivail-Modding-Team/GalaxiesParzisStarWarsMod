...
public class TooltipUtil
{
	public static Text getLore(Item item, Object... args)
	{
		...
		return new TranslatableText(getLoreKey(reg), args).formatted(Formatting.GRAY, Formatting.ITALIC);
	}
	...
	{
		var reg = Registry.ITEM.getId(item);
		return new TranslatableText(getStatusKey(reg), args).formatted(Formatting.GRAY);
	}
