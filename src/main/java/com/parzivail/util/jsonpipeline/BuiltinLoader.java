...
public class BuiltinLoader
{
	...
	public static final BlockbenchGeometry MODEL_GENERATED = BlockbenchGeometry.deserialize(EMPTY_MODEL_RAW).asBuiltin();
	public static final BlockbenchGeometry MODEL_ENTITY = BlockbenchGeometry.deserialize(EMPTY_MODEL_RAW).asBuiltin();
	...
	public static final BlockbenchGeometry MODEL_MISSING = BlockbenchGeometry.deserialize(MISSING_MODEL_MESH).asBuiltin();
