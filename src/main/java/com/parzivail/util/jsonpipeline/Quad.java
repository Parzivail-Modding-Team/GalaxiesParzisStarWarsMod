...
/**
 * Quad class used with permission from tterrag. Thank you!
 */
public class Quad
{
	@Deprecated
	...
	private static final ISubmap FULL_TEXTURE = new Submap(16, 16, 0, 0);
	...
	public BakedQuad rebake()
	{
		...
		if (hasLightmap)
		{
			...
			{ // ITEM is convertable to BLOCK (replace normal+padding with lmap)
	...
	{
		return transformUVs(sprite, FULL_TEXTURE.normalize());
	}
	...
	public static class Builder implements IVertexConsumer
	{
		...
		public Builder(VertexFormat format, TextureAtlasSprite sprite)
		{
			vertexFormat = format;
			this.sprite = sprite;
		}
