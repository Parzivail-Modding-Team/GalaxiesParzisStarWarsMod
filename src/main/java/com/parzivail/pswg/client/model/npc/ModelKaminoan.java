...
public class ModelKaminoan<T extends LivingEntity> extends PlayerEntityModel<T>
{
	...
	public ModelKaminoan(boolean male, float scale)
	{
		...
		PlayerEntityModelUtil.setJacket(this, new ModelPart(this, 21, 36));
		...
		PlayerEntityModelUtil.setRightSleeve(this, new ModelPart(this, 40, 30));
		...
		PlayerEntityModelUtil.setLeftSleeve(this, new ModelPart(this, 40, 48));
		...
		PlayerEntityModelUtil.setRightPantLeg(this, new ModelPart(this, 9, 30));
		this.rightPantLeg.setPivot(-0.5F, 7.9F, 1.0F);
		this.rightPantLeg.addCuboid(-2.0F, 0.0F, -2.0F, 2, 16, 2, 0.2F);
		PlayerEntityModelUtil.setLeftPantLeg(this, new ModelPart(this, 9, 48));
