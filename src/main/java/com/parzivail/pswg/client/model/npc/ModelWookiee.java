...
public class ModelWookiee<T extends LivingEntity> extends PlayerEntityModel<T>
{
	...
	public ModelWookiee(boolean male, float scale)
	{
		...
		this.body = new ModelPart(this, 16, 17);
		...
		this.rightPants.setPivot(-2.0F, 12.0F, 0.0F);
		this.rightPants.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.2F);
		this.leftLeg = new ModelPart(this, 16, 49);
		this.leftLeg.setPivot(1.9F, 12.0F, 0.0F);
		this.leftLeg.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		this.hat = new ModelPart(this, 32, 0);
		this.hat.setPivot(0.0F, -1.0F, 0.0F);
		this.hat.addCuboid(-4.0F, -8.0F, -4.0F, 8, 9, 8, 0.2F);
		...
		this.leftPants.setPivot(2.0F, 12.0F, 0.0F);
		this.leftPants.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.2F);
