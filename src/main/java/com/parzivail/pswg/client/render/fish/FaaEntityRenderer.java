...
import com.parzivail.pswg.client.model.fish.FaaEntityModel;
...
public class FaaEntityRenderer extends MobEntityRenderer<FishEntity, FaaEntityModel<FishEntity>>
{
	public FaaEntityRenderer(EntityRendererFactory.Context context)
	{
		super(context, new FaaEntityModel<>(), 0.5f);
	}
