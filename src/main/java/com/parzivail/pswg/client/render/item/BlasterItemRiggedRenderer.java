...
public class BlasterItemRiggedRenderer implements ICustomItemRenderer, ICustomPoseItem
{
	public static final BlasterItemRiggedRenderer INSTANCE = new BlasterItemRiggedRenderer();
	...
	private ModelEntry getModel(Identifier id)
	{
		...
		var p3dManager = Client.ResourceManagers.getP3dManager();
		var file = p3dManager.get(new Identifier(id.getNamespace(), "blaster/" + id.getPath()));
