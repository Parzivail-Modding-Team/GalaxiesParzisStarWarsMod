...
public class SwgSpecies
{
	...
	public static final Identifier SPECIES_BITH_M = register(Resources.identifier("bith_m"));
	public static final Identifier SPECIES_BITH_F = register(Resources.identifier("bith_f"));
