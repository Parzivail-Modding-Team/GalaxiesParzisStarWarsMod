...
public class SwgEntities
{
	public static class Ship
	{
		...
		public static final EntityType<ShipEntity> T65bXwing = Registry.register(Registry.ENTITY_TYPE, Resources.identifier("ship"), FabricEntityTypeBuilder.create(EntityCategory.MISC, ShipEntity::new).dimensions(EntityDimensions.fixed(1, 1)).build());
	}
}
