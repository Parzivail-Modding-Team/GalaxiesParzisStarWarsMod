...
public class SwgTags
{
	public static class Block
	{
		...
		public static final Tag.Identified<net.minecraft.block.Block> DESERT_SANDSTONE = TagFactory.BLOCK.create(Resources.id("desert_sandstone"));
	...
	public static class Item
	{
		...
		public static final Tag.Identified<net.minecraft.item.Item> DESERT_SANDSTONE = TagFactory.ITEM.create(Resources.id("desert_sandstone"));
