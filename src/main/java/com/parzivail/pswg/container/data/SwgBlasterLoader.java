...
public class SwgBlasterLoader extends JsonDataLoader
{
	...
	public SwgBlasterLoader()
	{
		super(GSON, "items/blasters");
	}

	public static SwgBlasterLoader get(MinecraftServer server)
	{
	...
	private BlasterDescriptor readBlasterDescriptor(Identifier key, PacketByteBuf buf)
	{
		...
		return new BlasterDescriptor(
				...
				new BlasterHeatInfo(heat_capacity, heat_perRound),
