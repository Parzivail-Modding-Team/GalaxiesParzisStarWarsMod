...
public class OldTatooineChunkGenerator extends ChunkGenerator
{
	public static final Codec<OldTatooineChunkGenerator> CODEC = RecordCodecBuilder.create((instance) -> instance.group(BiomeSource.CODEC.fieldOf("biome_source").forGetter((generator) -> generator.populationSource)).apply(instance, instance.stable(OldTatooineChunkGenerator::new)));
	...
	public OldTatooineChunkGenerator(BiomeSource biomeSource)
	{
