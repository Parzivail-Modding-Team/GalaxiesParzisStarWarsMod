...
public class ToolkitHomeScreen extends JComponentScreen
{
	...
	private void $$$setupUI$$$()
	{
		...
		panel2.add(spacer2, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		tbToolDesc = new JTextArea();
		tbToolDesc.setAutoscrolls(true);
		...
		panel1.add(tbToolDesc, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, new Dimension(50, 10), new Dimension(150, 10), null, 0, false));
	}
		...
		availableTools.setModel(new NodeTreeModel<>(
				new NodeTreeModel.Node<Tool>(LangUtil.translate("tool.category.tools"), null)
						.child(new NodeTreeModel.Node<Tool>(LangUtil.translate("tool.category.modeling"), null)
								       .child(createToolNode("nemi_compiler", NemiCompilerScreen::new))
