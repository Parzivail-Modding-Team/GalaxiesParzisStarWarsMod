...
public class SwgItems
{
	...
	public static class Armor
	{
		...
		@RegistryName("incineratortrooper")
		public static final ArmorItems Incineratortrooper = new ArmorItems(ArmorMaterials.DIAMOND, new Item.Settings().maxCount(1));
		@RegistryName("incineratortrooper_tank")
		@TarkinItem(tags = { TrItemTag.TrinketsChestBack })
		public static final TrinketItem IncineratortrooperTank = new TrinketItem(new Item.Settings().maxCount(1));
		...
		@RegistryName("white_heavy_backpack")
		@TarkinItem(tags = { TrItemTag.TrinketsChestBack })
		public static final TrinketItem WhiteHeavyBackpack = new TrinketItem(new Item.Settings().maxCount(1));
		@RegistryName("green_heavy_backpack")
		@TarkinItem(tags = { TrItemTag.TrinketsChestBack })
		public static final TrinketItem GreenHeavyBackpack = new TrinketItem(new Item.Settings().maxCount(1));
	...
	public static class Explosives
	{
		...
		@TarkinItem
		public static final Item ThermalDetonator = new ThermalDetonatorItem(new FabricItemSettings().maxCount(8));
	}
