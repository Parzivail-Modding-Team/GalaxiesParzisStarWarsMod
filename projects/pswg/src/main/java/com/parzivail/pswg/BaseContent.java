...
public class BaseContent implements PswgAddon, PswgClientAddon
{
	...
	private static void registerBlasters()
	{
		PswgContent.registerBlasterPreset(
				...
				new BlasterDescriptor(
						...
						new BlasterAttachmentBuilder()
								.attachment(1, "stock_wood", BlasterAttachmentFunction.REDUCE_RECOIL, BlasterAttachmentCategory.STOCK, "stock", Resources.id("textures/model/blaster/ee3_esb.png"))
								.attachment(1, "stock_metal", BlasterAttachmentFunction.REDUCE_SPREAD, BlasterAttachmentCategory.STOCK, "stock", Resources.id("textures/model/blaster/ee3_rotj.png"))
								.attachment(2, "tall_scope", BlasterAttachmentFunction.DEFAULT_SCOPE, BlasterAttachmentCategory.SCOPE, "tall_scope", Resources.id("textures/model/blaster/ee3_esb.png"))
								.attachment(2, "short_scope", BlasterAttachmentFunction.DEFAULT_SCOPE, BlasterAttachmentCategory.SCOPE, "short_scope", Resources.id("textures/model/blaster/ee3_rotj.png"))
								.attachment(3, "smooth_barrel", BlasterAttachmentFunction.INCREASE_RANGE, BlasterAttachmentCategory.BARREL, "smooth_barrel", Resources.id("textures/model/blaster/ee3_esb.png"))
								.attachment(3, "vane_barrel", BlasterAttachmentFunction.ALLOW_BURST, BlasterAttachmentCategory.BARREL, "vane_barrel", Resources.id("textures/model/blaster/ee3_rotj.png"))
								.required(1)
								.preset(1, "stock_wood")
								.required(2)
								.preset(2, "tall_scope")
	...
	private static void registerLightsabers()
	{
		PswgContent.registerLightsaberPreset(
				new LightsaberDescriptor(Resources.id("anakin"), "Anakin Skywalker", Resources.id("item/lightsaber/anakin"), 0.62f, 1, 1),
				new LightsaberDescriptor(Resources.id("ezra_padawan"), "Ezra Bridger", Resources.id("item/lightsaber/ezra_padawan"), 0.33f, 1, 1),
				new LightsaberDescriptor(Resources.id("kenobi"), "Obi-Wan Kenobi", Resources.id("item/lightsaber/kenobi"), 0.62f, 1, 1),
				new LightsaberDescriptor(Resources.id("kenobi_padawan"), "Padawan Obi-Wan Kenobi", Resources.id("item/lightsaber/kenobi_padawan"), 0.62f, 1, 1),
				new LightsaberDescriptor(Resources.id("luke_rotj"), "Luke Skywalker", Resources.id("item/lightsaber/luke_rotj"), 0.33f, 1, 1),
				new LightsaberDescriptor(Resources.id("qui_gon"), "Qui-Gon Jinn", Resources.id("item/lightsaber/qui_gon"), 0.33f, 1, 1),
				new LightsaberDescriptor(Resources.id("vader"), "Darth Vader", Resources.id("item/lightsaber/vader"), 0, 1, 1)
		);
	}
