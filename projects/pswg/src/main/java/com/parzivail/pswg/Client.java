...
public class Client implements ClientModInitializer
{
	...
	public void onInitializeClient()
	{
		...
		SwgModelPredicateProviders.register();
		...
		for (var color : DyeColor.values())
			ModelRegistry.register(SwgBlocks.Crate.Segmented.get(color), true, ModelLoader.loadP3D(DynamicBakedModel.CacheMethod.BLOCKSTATE_KEY, Resources.id("block/segmented_crate"), Resources.id("trims/blocks/model/segmented_crate_" + color.getName()), Resources.id("trims/blocks/model/segmented_crate_particle_" + color.getName())));
		...
		ModelRegistry.registerConnectedLamp(SwgBlocks.Panel.ImperialLightTall1, false, true, false, Resources.id("block/gray_imperial_panel_pattern_3"));
		ModelRegistry.registerConnectedLamp(SwgBlocks.Panel.ImperialLightTall2, false, true, false, Resources.id("block/gray_imperial_panel_pattern_3"));
