...
import com.parzivail.pswg.features.grenades.GrenadeUtil;
...
public class Client implements ClientModInitializer
{
	...
	public void onInitializeClient()
	{
		...
		EntityRendererRegistry.register(SwgEntities.Misc.FragmentationGrenade, FragmentationGrenadeRenderer::new);
		...
		ClientPlayNetworking.registerGlobalReceiver(SwgPackets.S2C.FragmentationGrenadeExplode, GrenadeUtil::handleFragmentationGrenadeExplosion);
