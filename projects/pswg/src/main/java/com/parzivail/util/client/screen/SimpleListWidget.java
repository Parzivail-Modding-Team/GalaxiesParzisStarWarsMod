...
public class SimpleListWidget<T> extends AlwaysSelectedEntryListWidget<SimpleListWidget.Entry<T>>
{
	...
	public void setEntrySelector(Function<List<SimpleListWidget.Entry<T>>, SimpleListWidget.Entry<T>> entrySelector)
	{
	...
	public void setEntries(List<T> values)
	{
		...
		for (var value : values)
			addEntry(new SimpleListWidget.Entry<>(this, value));
	...
	public List<SimpleListWidget.Entry<T>> getEntries()
	{
		return children();
	}
