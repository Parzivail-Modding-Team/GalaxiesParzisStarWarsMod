...
public class ReducedDryingRuiningStoneProducts
{
	...
	public ReducedDryingRuiningStoneProducts(BlockBehaviour.Properties settings, String key, Block targetBlock, Block ruinedBlock, int transitionTime, ColorRGBA color)
	{
		...
		VerticalSlabBlock ruinedSlab = (VerticalSlabBlock)BuiltInRegistries.BLOCK.getValue(Identifier.parse(getBlockKey(ruinedBlock) + "_slab"));
		...
		StairBlock ruinedStairs = (StairBlock)BuiltInRegistries.BLOCK.getValue(Identifier.parse(getBlockKey(ruinedBlock) + "_stairs"));
