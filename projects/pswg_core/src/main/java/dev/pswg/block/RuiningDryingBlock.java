...
public class RuiningDryingBlock extends FallingMutatingBlock
{
	...
	public RuiningDryingBlock(Block target, int meanTransitionTime, Supplier<Block> ruinedBlock, Settings settings, ColorCode colorCode)
	{
	...
	protected void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity, EntityCollisionHandler handler, boolean bl)
	{
		...
		{
			if (!world.isClient() && entity instanceof LivingEntity && (entity instanceof PlayerEntity || serverWorld.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) &&
