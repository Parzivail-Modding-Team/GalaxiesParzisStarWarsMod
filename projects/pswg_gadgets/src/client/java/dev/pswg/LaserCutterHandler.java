...
public class LaserCutterHandler
{
	...
	public static void tick(MinecraftClient client)
	{
		...
		{
			double distanceMod = (player.getBlockInteractionRange() - player.getPos().distanceTo(mainStack.get(GadgetsItems.Components.CURRENT_BLOCK).toCenterPos())) / player.getBlockInteractionRange();
