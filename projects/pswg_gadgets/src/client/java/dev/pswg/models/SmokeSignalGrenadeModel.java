...
public class SmokeSignalGrenadeModel extends EntityModel<EntityRenderState>
{
	...
	public static TexturedModelData getTexturedModelData()
	{
		...
		modelPartData.addChild("trigger", ModelPartBuilder.create().uv(0, 6).cuboid(-0.5F, -3.5F, -0.75F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0F, 0F, 0F, 0, 0, (float)Math.PI));
