...
public class ThermalDetonatorGrenadeModel extends EntityModel<EntityRenderState>
{
	...
	public static LayerDefinition getTexturedModelData()
	{
		...
		modelPartData.addOrReplaceChild("trigger", CubeListBuilder.create().texOffs(0, 6).addBox(-0.5F, -3.5F, -0.75F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		                       PartPose.offsetAndRotation(0F, 0F, 0F, 0, 0, (float)Math.PI));
