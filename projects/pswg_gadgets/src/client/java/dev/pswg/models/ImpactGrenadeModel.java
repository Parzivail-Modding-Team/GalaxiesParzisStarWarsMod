...
public class ImpactGrenadeModel extends EntityModel<GrenadeRenderState>
{
	...
	public static TexturedModelData getTexturedModelData()
	{
		...
		modelPartData.addChild("pin", ModelPartBuilder.create()
		                                              .uv(6, 13).cuboid(1F, -5F, -1.25F, 0.0F, 1.0F, 2.0F, new Dilation(0.025F))
		                                              .uv(6, 13).cuboid(-1.0F, -5F, -1.25F, 0.0F, 1.0F, 2.0F, new Dilation(0.025F))
		                                              .uv(2, 15).cuboid(-1.0F, -5.F, -1.25F, 2.0F, 1.0F, 0.0F, new Dilation(0.026F))
		                                              .uv(12, 15).cuboid(-1.0F, -5.F, 0.75F, 2.0F, 1.0F, 0.0F, new Dilation(0.026F)),
		                       ModelTransform.of(0F, 0.25F, 0, 0.1745F, 0, (float)Math.PI));
