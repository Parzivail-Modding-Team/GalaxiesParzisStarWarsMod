...
{
	public static final EntityModelLayer MODEL_LAYER = new EntityModelLayer(Gadgets.id("inferno_grenade"), "temp");
	public static final Identifier TEXTURE = Identifier.of("pswg_gadgets", "textures/items/inferno_grenade.png");
	private final ThermalDetonatorGrenadeModel model;

	public InfernoGrenadeEntityRenderer(EntityRendererFactory.Context context)
	{
		super(context);
	...
	@Override
	public void updateRenderState(InfernoGrenadeEntity entity, GrenadeRenderState state, float tickDelta)
	{
