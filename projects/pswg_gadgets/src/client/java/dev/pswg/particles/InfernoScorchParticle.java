...
public class InfernoScorchParticle extends DecalParticle
{
	...
	protected InfernoScorchParticle(ClientLevel clientWorld, double x, double y, double z, double vX, double vY, double vZ, float heat, SpriteSet spriteProvider)
	{
		...
		this.lifetime = clientWorld.random.nextIntBetweenInclusive(100, 200);
		this.hasPhysics = false;
		this.xd = vX;
		this.yd = vY;
		this.zd = vZ;
		this.roll = (float)(clientWorld.random.nextIntBetweenInclusive(1, 4) * Math.PI / 2f);
	...
	public static class Factory implements ParticleProvider<SimpleParticleType>
	{
		...
		public @Nullable Particle createParticle(SimpleParticleType parameters, ClientLevel world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, RandomSource random)
		{
			...
			return new InfernoScorchParticle(world, x, y, z, normal.x, normal.y, normal.z, (float)heat, this.spriteProvider);
		}
	}
}
