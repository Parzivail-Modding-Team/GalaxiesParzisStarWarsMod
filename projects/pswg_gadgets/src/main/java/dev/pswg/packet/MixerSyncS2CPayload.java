...
public record MixerSyncS2CPayload(ArrayList<StatusEffectInstance> drinkEffects, ArrayList<Integer> drinkColors) implements CustomPayload
{
	...
	private static MixerSyncS2CPayload fromPacket(RegistryByteBuf buf)
	{
		...
		return new MixerSyncS2CPayload(effects, colours);
	}
