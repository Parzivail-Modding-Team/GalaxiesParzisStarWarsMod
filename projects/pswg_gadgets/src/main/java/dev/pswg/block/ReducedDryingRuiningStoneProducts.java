...
public class ReducedDryingRuiningStoneProducts
{
	...
	{
		this.block = Registrar.block(Gadgets.id(key), blockSettings -> new RuiningDryingBlock(targetBlock, transitionTime, () -> ruinedBlock, blockSettings, color), settings);
		...
		this.slab = Registrar.block(Gadgets.id(key + "_slab"), blockSettings -> new RuiningDryingSlabBlock(targetSlab, transitionTime, () -> ruinedSlab, blockSettings), settings);
		...
		this.stairs = Registrar.block(Gadgets.id(key + "_stairs"), blockSettings -> new RuiningDryingStairsBlock(block.getDefaultState(), targetStairs, transitionTime, () -> ruinedStairs, blockSettings), settings);
	}
