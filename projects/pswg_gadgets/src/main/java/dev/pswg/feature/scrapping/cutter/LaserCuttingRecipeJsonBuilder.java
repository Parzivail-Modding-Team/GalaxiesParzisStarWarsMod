...
public class LaserCuttingRecipeJsonBuilder
{
	...
	public LaserCuttingRecipeJsonBuilder(HolderGetter<Item> registryLookup, Ingredient input, ItemStack primaryOutput, ItemStack secondaryOutput, float secondaryChance)
	{
	...
	public static LaserCuttingRecipeJsonBuilder create(HolderGetter<Item> registryLookup, Ingredient input, ItemStack primaryOutput, ItemStack secondaryOutput, float secondaryChance)
	{
