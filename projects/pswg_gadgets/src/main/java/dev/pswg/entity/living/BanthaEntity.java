...
public class BanthaEntity extends AnimalEntity implements Saddleable, ILeftClickingEntity
{
	...
	{
		BanthaEntity banthaEntity = LivingEntities.Bantha.create(world, SpawnReason.BREEDING);
	...
	protected void initDataTracker(DataTracker.Builder builder)
	{
		...
		this.dataTracker.set(PLAYER_BRED, false);
	}
