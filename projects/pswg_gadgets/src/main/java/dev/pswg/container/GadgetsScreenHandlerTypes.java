...
public class GadgetsScreenHandlerTypes
{
	...
	public static final ExtendedScreenHandlerType<MixerScreenHandler, MixerSyncS2CPayload> MIXER = new ExtendedScreenHandlerType<>((syncId, inventory, data) -> new MixerScreenHandler(syncId, inventory, data.drinkEffects(), data.drinkColors()), MixerSyncS2CPayload.CODEC);
