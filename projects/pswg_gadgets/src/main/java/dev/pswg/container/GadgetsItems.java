...
public class GadgetsItems
{
	...
	public static final Item BROKEN_SMALL_POWER_PACK_ITEM = Registrar.item(Gadgets.id("broken_small_power_pack"), Item::new, new Item.Settings().component(Components.METAL_COMPONENT, 1).component(Components.ENERGY_COMPONENT, 3).component(Components.TECH_COMPONENT, 2));
