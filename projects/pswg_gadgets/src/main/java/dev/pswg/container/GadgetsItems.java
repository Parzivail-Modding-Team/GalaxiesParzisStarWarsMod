...
public class GadgetsItems
{
	...
	@DataGenItem
	public static final DyedItems DOOR_INSERT = new DyedItems(color -> Registrar.item(Gadgets.id(color.name().toLowerCase() + "_door_insert"), settings -> new DoorInsertItem(color, settings), new Item.Settings()));
	...
	@DataGenItem(model = ItemModel.handheld)
	public static final HoeItem BESKAR_HOE = Registrar.item(Gadgets.id("beskar_hoe"), settings -> new HoeItem(GadgetsToolMaterials.BESKAR, 0, 0.0F, settings), new Item.Settings());
	...
	@DataGenItem(model = ItemModel.handheld)
	public static final ShovelItem DURASTEEL_SHOVEL = Registrar.item(Gadgets.id("durasteel_shovel"), settings -> new ShovelItem(GadgetsToolMaterials.DURASTEEL, 1.5F, -3.0F, settings), new Item.Settings());
	@DataGenItem(model = ItemModel.handheld)
	public static final AxeItem DURASTEEL_AXE = Registrar.item(Gadgets.id("durasteel_axe"), settings -> new AxeItem(GadgetsToolMaterials.DURASTEEL, 5, -3.0F, settings), new Item.Settings());
	@DataGenItem(model = ItemModel.handheld)
	...
	@DataGenItem(model = ItemModel.handheld)
	public static final HoeItem TITANIUM_HOE = Registrar.item(Gadgets.id("titanium_hoe"), settings -> new HoeItem(GadgetsToolMaterials.TITANIUM, 0, 0.0F, settings), new Item.Settings());
	...
	@DataGenItem
	public static final Item EYE_OF_SKETTO = registerSimpleItem("eye_of_sketto", new Item.Settings().component(Components.BREWING_PATH, new ArrayList<>(Arrays.asList(Pair.of((float)Math.PI * 7 / 6f, 25f), Pair.of((float)Math.PI * 5 / 6f, 30f), Pair.of((float)Math.PI * 7 / 6f, 20f)))));
	@DataGenItem
