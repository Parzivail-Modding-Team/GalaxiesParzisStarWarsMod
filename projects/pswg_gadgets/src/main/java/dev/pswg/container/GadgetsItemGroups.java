...
public class GadgetsItemGroups
{
	...
	public static final ItemGroup CONSTRUCTION_BLOCK_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(GadgetsBlocks.GRAY_IMPERIAL_PANEL_PATTERN_9)).displayName(Text.translatable("pswg_gadgets.construction_block_group")).build();
	...
	public static final ItemGroup GENERIC_ITEMS_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(GadgetsItems.DURASTEEL_ROD)).displayName(Text.translatable("pswg_gadgets.item_group")).build();

	public static final RegistryKey<ItemGroup> FOOD_ITEMS_GROUP_KEY = registerGroup("food_items");
	public static final ItemGroup FOOD_ITEMS_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(GadgetsItems.BANTHA_COOKIE)).displayName(Text.translatable("pswg_gadgets.food_item_group")).build();
